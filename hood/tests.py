...
class ProfileTestClass(TestCase):
    def setUp(self):
        self.new_user = User(username="Andrew", email="kiplani@gmail.com", password="1234")
        self.new_user.save()

        self.new_neighbourhood=Neighbourhood(name='Langata',population=20101000)
        self.new_neighbourhood.save()
        self.new_profile = Profile(user=self.new_user,images="avatar.jpg",bio="just testing", hood=self.new_neighbourhood)
    # test for instance
    def test_instance(self):
